...
export function ServicesSection() {
  return (
    <section id="servicos" className="border-b border-border bg-secondary/40 py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {services.map(({ icon: Icon, title, description }) => (
            ...
            >
              <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-accent text-copper">
