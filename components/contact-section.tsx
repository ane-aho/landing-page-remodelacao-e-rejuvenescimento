...
export function ContactSection() {
  return (
    <section id="contato" className="py-20 md:py-28">
      <div className="mx-auto max-w-4xl border-t border-border px-4 pt-14 text-center md:px-6">
        ...
        <p className="mt-12 text-sm font-semibold uppercase tracking-[0.14em] text-copper">
          Nosso contato
        </p>
